class PagesController < ApplicationController
  ...
  def dashboard
    ...
    @sessions = Session.where(campaign_id: @campaigns.select { |campaign| campaign.user == current_user }) || Session.where(campaign_id: @campaigns.select { |campaign| campaign.character.user == current_user})
  end
end
